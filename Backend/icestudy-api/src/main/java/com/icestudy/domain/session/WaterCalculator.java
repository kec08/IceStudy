...
public class WaterCalculator {
    ...
    /**
     * 실제 경과 시간에 비례하여 물양을 계산합니다.
     *
     * 공식: waterMl = (elapsedTime / maxSeconds) x maxMl
     * - 컵 사이즈의 최대 시간 기준으로 비례 계산
    ...
    public static double calculate(CupSize cupSize, int totalDuration, int elapsedTime) {
        ...
        double progress = Math.min((double) elapsedTime / cupSize.getMaxSeconds(), 1.0);
